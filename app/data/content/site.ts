...
export const SITE_TAGLINE = "Apprendre à travailler, ça s'apprend.";
...
export const OFFER_NAV_LINKS = [
  { href: "/offres/formation-en-ligne", label: "Formation en ligne" },
  { href: "/offres/stage-vacances", label: "Stages de vacances" },
  { href: "/offres/cours-hebdomadaires", label: "Cours hebdomadaires" },
  { href: "/offres/accompagnement-personnalise", label: "Accompagnement personnalisé" },
] as const;
