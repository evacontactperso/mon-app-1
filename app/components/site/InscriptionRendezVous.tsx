...
const SECTION = {
  ...
  subtitle:
    "Les places sont limitées afin de garantir un accompagnement attentif et des séances réellement pratiques",
} as const;
...
const FEATURE_CARDS: FeatureCard[] = [
  {
    id: "format",
    label: "Format",
    value: "1h30 par séance (45 min de méthode + 45 min de pratique)",
    tone: "amber",
    icon: "bolt",
  },
  {
    id: "dates",
    label: "Dates",
    value: "Week-ends — rentrée 2026-2027, selon l'agenda des séances",
    tone: "indigo",
    icon: "calendar",
  },
  {
    id: "groupe",
    label: "Groupe",
    value: "Petit effectif, séances collectives en ligne",
    tone: "green",
    icon: "users",
  },
  {
  ...
  },
  {
    id: "objectif",
    label: "Objectif",
    value: "Installer une méthode de travail claire et durable",
    tone: "pink",
    icon: "target",
  },
  {
...
const PRICING = {
  ...
  includes: [
    ...
    "Thèmes alignés sur le rythme de l'année scolaire",
