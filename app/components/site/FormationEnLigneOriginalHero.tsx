...
type FormationEnLigneOriginalHeroProps = {
  badge?: string;
...
export default function FormationEnLigneOriginalHero({
  badge,
  highlightWord,
  title,
  subtitle,
  ...
  modules,
  floatingTags,
}: FormationEnLigneOriginalHeroProps) {
  return (
    <section className="relative flex min-h-[100svh] flex-col justify-center overflow-hidden bg-gradient-to-br from-[#fde8e8]/30 via-white to-[#EEF2FF]/40 py-16 md:py-20">
      ...
      <div className="relative mx-auto grid w-full max-w-6xl items-center gap-12 px-4 md:px-6 lg:grid-cols-2 lg:gap-16">
        <div>
          ...
          <h1
            className={`text-3xl font-bold leading-tight text-[#0B0B0B] md:text-4xl lg:text-[2.75rem] ${badge ? "mt-5" : ""}`}
          >
        ...
        <div className="relative mx-auto w-full max-w-lg" aria-hidden>
          ...
          <div className="relative rounded-[32px] border border-slate-200/60 bg-gradient-to-br from-[#EEF2FF] via-white to-[#fde8e8]/40 p-6 shadow-[0_24px_70px_rgba(15,23,42,0.1)] md:p-8">
            ...
            <div className="mt-4 h-2 overflow-hidden rounded-full bg-slate-100">
              <div className="h-full w-1/2 rounded-full bg-gradient-to-r from-[#6366F1] via-[#EE6B6E] to-[#8134af]" />
            </div>
